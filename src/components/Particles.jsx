...
export const Particles = ({
  ...
  useEffect(() => {
    ...
    const onVisibility = () => {
      // Pause when tab is hidden to avoid wasting CPU/GPU.
      isActiveRef.current = document.visibilityState === "visible";
      if (isActiveRef.current && rafID.current == null) {
        animate();
      }
    };
    document.addEventListener("visibilitychange", onVisibility);

    // Pause when not in view (huge perf win on scroll-heavy pages)
    let io;
    if (typeof IntersectionObserver !== "undefined" && canvasContainerRef.current) {
